...
@pytest.mark.parametrize(
    ...
    [
        ...
        DownloadResult(None, DownloadStatus.CHECKSUM_MISMATCH, None, "bar.tar"),
    ],
)
def test_download_result_format(dlschema, dlresult):
    ...
    # if we provide a package, it also must be in the json data
    assert (dlresult.package is not None) == ("package" in data)
