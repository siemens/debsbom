...
*   **status**:
    The current status of the operation. This field will contain one of the
...
*   **filename**:
    The name of the specific file being processed or an empty string if the package was not found.
